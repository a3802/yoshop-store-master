...
import pdd from '@/assets/icons/page/components/pdd.svg?inline'

export { image, banner, article, navBar, notice, search, video, window, goods, service, guide, richText, blank, pdd }