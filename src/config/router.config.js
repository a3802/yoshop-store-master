...
export const asyncRouterMap = [
        ...
        children: [
            ...
            // 管理员
            {
                ...
                children: [{
                        ...
                        component: () =>
                            import ( /* webpackChunkName: "manage" */ '@/views/manage/user/Index'),
                        meta: { title: '管理员列表', keepAlive: false, permission: ['/manage/user/index'] }
                    },
                    {
                        path: '/manage/role/index',
                        component: () =>
                            import ( /* webpackChunkName: "manage" */ '@/views/manage/role/Index'),
            ...
            // 店铺管理
            {
                ...
                children: [{
                        path: '/store/setting',
                        component: () =>
                            import ( /* webpackChunkName: "store" */ '@/views/store/Setting'),
                        meta: { title: '店铺设置', keepAlive: false, permission: ['/store/setting'] }
                    },
                    {
                        path: '/store/address/index',
                        component: () =>
                            import ( /* webpackChunkName: "store" */ '@/views/store/address/Index'),
                    ...
                    },
                    {
                        ...
                        children: [{
                                path: '/page/index',
                                component: () =>
                                    import ( /* webpackChunkName: "page" */ '@/views/page/Index'),
                            ...
                            },
                            {
                                path: '/page/create',
                                component: () =>
                                    import ( /* webpackChunkName: "page" */ '@/views/page/Create'),
                            ...
                            },
                            {
                                path: '/page/update',
                                component: () =>
                                    import ( /* webpackChunkName: "page" */ '@/views/page/Update'),
                            ...
                            },
                            {
                                path: '/page/category',
                                component: () =>
                                    import ( /* webpackChunkName: "page" */ '@/views/page/category/Index'),
            ...
            // 商品管理
            {
                ...
                children: [{
                        path: '/goods/index',
                        component: () =>
                            import ( /* webpackChunkName: "goods" */ '@/views/goods/Index'),
                    ...
                    },
                    {
                        path: '/goods/create',
                        component: () =>
                            import ( /* webpackChunkName: "goods" */ '@/views/goods/Create'),
                    ...
                    },
                    {
                        path: '/goods/update',
                        component: () =>
                            import ( /* webpackChunkName: "goods" */ '@/views/goods/Update'),
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ( /* webpackChunkName: "goods" */ '@/views/goods/category/Index'),
                    ...
                    // },
                    {
                        ...
                        component: () =>
                            import ( /* webpackChunkName: "goods" */ '@/views/goods/service/Index'),
                        meta: { title: '服务承诺', keepAlive: false, permission: ['/goods/service/index'] }
                    },
                    {
                        path: '/goods/comment/index',
                        component: () =>
                            import ( /* webpackChunkName: "goods" */ '@/views/goods/comment/Index'),
            ...
            // 权益管理
            {
                ...
                meta: { title: '权益管理', icon: Icons.goods, permission: ['/product'] },
                children: [{
                        path: '/product/index',
                        component: () =>
                            import ( /* webpackChunkName: "product" */ '@/views/product/Index'),
                        meta: { title: '权益列表', keepAlive: false, permission: ['/product/index'] },
                        // 访问其他页面时激活该菜单(router-link-active)
                    ...
                    },
                    {
                        path: '/product/qylist',
                        component: () =>
                            import ( /* webpackChunkName: "product" */ '@/views/product/QList'),
                        meta: { title: '权益商品池', keepAlive: false, permission: ['/product/qylist'] },
                        // 访问其他页面时激活该菜单(router-link-active)
                        activePath: ['/product/create', '/product/update']
                    },
                    {
                        path: '/product/create',
                        component: () =>
                            import ( /* webpackChunkName: "goods" */ '@/views/product/Create'),
                        meta: { title: '创建权益商品', keepAlive: false, permission: ['/product/create'] },
                        hidden: true
                    },
                    {
                        path: '/product/update',
                        component: () =>
                            import ( /* webpackChunkName: "goods" */ '@/views/product/Update'),
                        meta: { title: '编辑权益商品', keepAlive: false, permission: ['/product/update'] },
                        hidden: true
                    }
                ]
            },
            ...
            // 订单管理
            {
                ...
                children: [{
                    ...
                    },
                    {
                        path: '/order/detail',
                        component: () =>
                            import ( /* webpackChunkName: "order" */ '@/views/order/Detail'),
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ( /* webpackChunkName: "order" */ '@/views/order/refund/Index'),
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ( /* webpackChunkName: "order" */ '@/views/order/refund/Detail'),
                    ...
                    },
                    {
                        ...
                        children: [{
                            ...
                            component: () =>
                                import ( /* webpackChunkName: "order" */ '@/views/order/tools/Export'),
            ...
            // 会员管理
            {
                ...
                children: [{
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ( /* webpackChunkName: "user" */ '@/views/user/grade/Index'),
                    ...
                    },
                    {
                        ...
                        children: [{
                                ...
                                component: () =>
                                    import ( /* webpackChunkName: "content" */ '@/views/user/recharge/Index'),
                                meta: { title: '充值记录', keepAlive: false, permission: ['/user/recharge/index'] }
                            },
                            {
                                path: '/user/balance/index',
                                component: () =>
                                    import ( /* webpackChunkName: "content" */ '@/views/user/balance/Index'),
            ...
            // 内容管理
            {
                ...
                children: [{
                        ...
                        children: [{
                                ...
                                component: () =>
                                    import ( /* webpackChunkName: "content" */ '@/views/content/article/Index'),
                                meta: { title: '文章列表', keepAlive: false, permission: ['/content/article/index'] }
                            },
                            {
                                path: '/content/article/category/index',
                                component: () =>
                                    import ( /* webpackChunkName: "content" */ '@/views/content/article/category/Index'),
                    ...
                    },
                    {
                        ...
                        children: [{
                                ...
                                component: () =>
                                    import ( /* webpackChunkName: "content" */ '@/views/content/files/Index'),
                                meta: { title: '文件列表', keepAlive: false, permission: ['/content/files/index'] }
                            },
                            {
                                path: '/content/files/group/index',
                                component: () =>
                                    import ( /* webpackChunkName: "content" */ '@/views/content/files/group/Index'),
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ( /* webpackChunkName: "content" */ '@/views/content/help/Index'),
            ...
            // 营销管理
            {
                ...
                children: [{
                        ...
                        children: [{
                                ...
                                component: () =>
                                    import ( /* webpackChunkName: "market" */ '@/views/market/coupon/Index'),
                            ...
                            },
                            {
                                ...
                                component: () =>
                                    import ( /* webpackChunkName: "market" */ '@/views/market/coupon/Create'),
                            ...
                            },
                            {
                                ...
                                component: () =>
                                    import ( /* webpackChunkName: "market" */ '@/views/market/coupon/Update'),
                            ...
                            },
                            {
                                ...
                                component: () =>
                                    import ( /* webpackChunkName: "market" */ '@/views/market/coupon/Receive'),
                    ...
                    },
                    {
                        ...
                        children: [{
                                ...
                                component: () =>
                                    import ( /* webpackChunkName: "market" */ '@/views/market/recharge/plan/Index'),
                                meta: { title: '充值套餐', keepAlive: false, permission: ['/market/recharge/plan/index'] }
                            },
                            {
                                path: '/market/recharge/setting',
                                component: () =>
                                    import ( /* webpackChunkName: "market" */ '@/views/market/recharge/Setting'),
                    ...
                    },
                    {
                        ...
                        children: [{
                                ...
                                component: () =>
                                    import ( /* webpackChunkName: "market" */ '@/views/market/points/Setting'),
                                meta: { title: '积分设置', keepAlive: false, permission: ['/market/points/setting'] }
                            },
                            {
                                path: '/market/points/log',
                                component: () =>
                                    import ( /* webpackChunkName: "market" */ '@/views/market/points/Log'),
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ( /* webpackChunkName: "market" */ '@/views/market/FullFree'),
            ...
            // 客户端
            {
                ...
                children: [{
                        ...
                        component: () =>
                            import ( /* webpackChunkName: "client" */ '@/views/client/Register'),
                    ...
                    },
                    {
                        ...
                        children: [{
                            ...
                            component: () =>
                                import ( /* webpackChunkName: "client" */ '@/views/client/wxapp/Setting'),
                    ...
                    },
                    {
                        ...
                        children: [{
                            ...
                            component: () =>
                                import ( /* webpackChunkName: "client" */ '@/views/client/h5/Setting'),
            ...
            // 设置
            {
                ...
                children: [{
                        path: '/setting/trade',
                        component: () =>
                            import ( /* webpackChunkName: "setting" */ '@/views/setting/Trade'),
                        meta: { title: '交易设置', keepAlive: false, permission: ['/setting/trade'] }
                    },
                    {
                        path: '/setting/storage',
                        component: () =>
                            import ( /* webpackChunkName: "setting" */ '@/views/setting/Storage'),
                        meta: { title: '上传设置', keepAlive: false, permission: ['/setting/storage'] }
                    },
                    {
                        path: '/setting/sms',
                        component: () =>
                            import ( /* webpackChunkName: "setting" */ '@/views/setting/Sms'),
                    ...
                    },
                    {
                        ...
                        children: [{
                                ...
                                component: () =>
                                    import ( /* webpackChunkName: "content" */ '@/views/setting/delivery/Setting'),
                                meta: { title: '配送方式', keepAlive: false, permission: ['/setting/delivery/setting'] }
                            },
                            {
                                path: '/setting/delivery/template/index',
                                component: () =>
                                    import ( /* webpackChunkName: "content" */ '@/views/setting/delivery/template/Index'),
                            ...
                            },
                            {
                                ...
                                component: () =>
                                    import ( /* webpackChunkName: "content" */ '@/views/setting/delivery/template/Create'),
                            ...
                            },
                            {
                                ...
                                component: () =>
                                    import ( /* webpackChunkName: "content" */ '@/views/setting/delivery/template/Update'),
                            ...
                            },
                            {
                                ...
                                component: () =>
                                    import ( /* webpackChunkName: "content" */ '@/views/setting/delivery/express/Index'),
                    ...
                    },
                    {
                        ...
                        children: [{
                            ...
                            component: () =>
                                import ( /* webpackChunkName: "content" */ '@/views/setting/other/Clear'),
    ...
    // 更新账户信息
    {
        ...
        children: [{
            path: 'renew',
            component: () =>
                import ( /* webpackChunkName: "manage" */ '@/views/manage/renew')
        }]
    },
...
export const constantRouterMap = [
    ...
    // 用户登录页
    {
        ...
        children: [{
            ...
            name: 'login',
            component: () =>
                import ( /* webpackChunkName: "passport" */ '@/views/passport/Login')
        }]
    },
